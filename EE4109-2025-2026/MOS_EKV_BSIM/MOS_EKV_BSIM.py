...
sl.initProject("MOS_EKV_BSIM")

# MS Windows: define the location of "ngspice.exe"
# ini.ngspice = '<path to ngspice.exe>'
...
LIB      = '.lib lib/log018.l TT'   # use this CMOS BSIM library
...
VD       = 0.9                 # Drain voltage w.r.t. GND
VP       = 1.8                 # Supply voltage w.r.t. GND
# ID will be ignored with "VGS" biasing
ID       = 1E-6                # Drain current noise
# VG will be ignored with "IDS" biasing
...
# Define the absolute value of the step size Vdiff and Idiff for VGS and IDS stepping, respectively.
...
plotOpinfo(device, biasPar, ID, VG, VD, VS, VB, f, stepVals, EKVlib="SLiCAP_C18.lib")

# plot the voltage noise
plotSvinoise(device, ID, VD, VS, VB, fmin, fmax, numDec, EKVlib="SLiCAP_C18.lib")