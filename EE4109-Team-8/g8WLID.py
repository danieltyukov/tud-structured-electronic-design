...
from g8specifications import global_specs, A1specs
from g8sourcenoise import DIN_A

sl.htmlPage('A1_controller_g8WLID')
...
while not mosType:
    ...
    if mosType != "N" and mosType != "P":
        mosType = False
if mosType == "N":
    cir = sl.makeCircuit("kicad/A1_controller_noiseWLI_n.kicad_sch")
    img = "A1_controller_noiseWLI_n.svg"
elif mosType == "P":
    cir = sl.makeCircuit("kicad/A1_controller_noiseWLI_p.kicad_sch")
